...
# 30 "../Core/Inc\\bdma.h" 2
# 41 "../Core/Inc\\bdma.h"
void MX_BDMA_Init(void);
# 23 "../Core/Src/bdma.c" 2
# 39 "../Core/Src/bdma.c"
void MX_BDMA_Init(void)
{


  do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->AHB4ENR) |= ((0x1UL << (21U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x18020000UL) + 0x4400UL))->AHB4ENR) & ((0x1UL << (21U)))); ((void)(tmpreg)); } while(0);
