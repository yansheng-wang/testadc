...
void SystemClock_Config(void)
{
  ...
  RCC_OscInitStruct.HSIState = ((0x0UL << (3U)) | (0x1UL << (0U)));
...
void MPU_Config(void)
{
  ...
  MPU_InitStruct.Size = ((uint8_t)0x1F);
  MPU_InitStruct.SubRegionDisable = 0x87;
  MPU_InitStruct.TypeExtField = ((uint8_t)0x00);
  MPU_InitStruct.AccessPermission = ((uint8_t)0x00);
  MPU_InitStruct.DisableExec = ((uint8_t)0x01);
  MPU_InitStruct.IsShareable = ((uint8_t)0x01);
